...
export const SEED_CUSTOMERS = {
  customers: [
    ...
    /*
      The register used to hold three customers while contracts and the board
      referenced eleven. Every absent one was a job that could not be billed:
      with no site there is no place of supply, so the invoice screen refused to
      send and was right to. Each entry below carries the locality the board
      already uses for that customer, and a real state code — which is what the
      tax head is derived from (FR-802).

      Sites only. Assets and timelines are genuinely unknown for these, and
      inventing a service history would be a fabricated record.
    */
    {
      id: "cus_3",
      name: "Deshmukh Hospital",
      customerType: "BUSINESS" as const,
      gstin: "07AACCD5512K1ZP",
      billingStateCode: "07",
      creditDays: 45,
      outstandingPaise: 0,
      sites: [
        {
          id: "site_4",
          label: "Main block",
          addressLine1: "Press Enclave Marg",
          locality: "Saket",
          city: "New Delhi",
          stateCode: "07",
          pincode: "110017",
          landmark: "Opposite Select Citywalk, gate 3",
          accessNotes: "Generator room via basement ramp. Sign in at security.",
          contacts: [],
          assets: [],
          timeline: [],
        },
    ...
    },
    {
      ...
      customerType: "BUSINESS" as const,
      // Registered in Haryana, so its invoices are IGST against a Delhi branch —
      // the interstate case the derivation exists to catch.
      gstin: "06AABCS1234M1Z5",
      billingStateCode: "06",
      creditDays: 15,
      outstandingPaise: 0,
      sites: [
        {
          ...
          stateCode: "06",
          pincode: "122003",
          landmark: "Behind the community centre",
          accessNotes: null,
          contacts: [],
          assets: [],
          timeline: [],
      ...
      sites: [
        {
          id: "site_6",
          label: "Depot",
          addressLine1: "Nehru Place Depot",
          locality: "Nehru Place",
          city: "New Delhi",
          stateCode: "07",
          pincode: "110019",
          landmark: "Behind the district centre",
          accessNotes: "Photo ID at the gate. No phones on the forecourt.",
          contacts: [],
          assets: [],
          timeline: [],
        },
      ...
      sites: [
        {
          id: "site_7",
          label: "Residence",
          addressLine1: "M-14, Greater Kailash II",
          locality: "Greater Kailash",
          city: "New Delhi",
          stateCode: "07",
          pincode: "110048",
          landmark: "Corner house, red gate",
          accessNotes: null,
          contacts: [],
          assets: [],
          timeline: [],
      ...
      sites: [
        {
          id: "site_8",
          label: "Shop",
          addressLine1: "Shop 22, Central Market",
          locality: "Lajpat Nagar",
          city: "New Delhi",
          stateCode: "07",
          pincode: "110024",
          landmark: "Above the sari shop",
          accessNotes: null,
          contacts: [],
          assets: [],
          timeline: [],
      ...
      sites: [
        {
          id: "site_9",
          label: "Clinic",
          addressLine1: "S-8, Green Park Main",
          locality: "Green Park",
          city: "New Delhi",
          stateCode: "07",
          pincode: "110016",
          landmark: "Above the chemist",
          accessNotes: "No work during OPD hours, 9 to 1.",
          contacts: [],
          assets: [],
          timeline: [],
        },
      ...
      sites: [
        {
          id: "site_10",
          label: "Shop",
          addressLine1: "2416, Bank Street",
          locality: "Karol Bagh",
          city: "New Delhi",
          stateCode: "07",
          pincode: "110005",
          landmark: "Next to the metro gate 2",
          accessNotes: null,
          contacts: [],
          assets: [],
          timeline: [],
      ...
      sites: [
        {
          id: "site_11",
          label: "Works",
          addressLine1: "B-88, Mayapuri Industrial Area Phase I",
          locality: "Mayapuri",
          city: "New Delhi",
          stateCode: "07",
          pincode: "110064",
